...
export default function Contacts() {
  ...
  return (
    ...
    >
      <h2 className="text-[#ee1c25] text-2xl xl:text-3xl font-bold mb-2 xl:mb-6">
        Контакты
      </h2>
      {/* Основной контейнер */}
      <div className="flex flex-col sm:flex-row justify-between gap-8">
        ...
        <div className="w-full sm:w-1/2 flex flex-col items-center sm:items-start gap-3">
          ...
          <div className="mt-8 space-y-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <span>
                Провинция Гуанси, г. Наньнин, район Лянцин, финансовый центр
                Цяньхай Жэньшоу, корпус Т1, 4502-4503, Сторона Б
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="w-full sm:w-1/2 max-w-[400px] mx-auto lg:ml-0">
          <h3 className="text-[#ee1c25] text-xl font-bold mb-6">
            Напишите нам
          </h3>

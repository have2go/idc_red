export default function About() {
    return (
        ...
        >
            <h2 className="text-[#ee1c25] text-2xl xl:text-3xl font-bold mb-2 xl:mb-6">О нас</h2>
            <p className="mb-3 xl:mb-4">
                Инициатива создания Информационно-деловых центров Санкт- Петербурга в Наньнине и Циндао принадлежит
                администрациям Санкт-Петербурга и китайских провинций. Проект нацелен на развитие делового
                сотрудничества с Китаем в различных сферах.
            </p>
            <p className="mb-3 xl:mb-4">
                Деятельность Центров направлена на расширение торгово-экономического, научно-технического и культурного
            ...
            <p className="mt-4">
                Первоочередными задачами центров является развитие и продвижение делового сотрудничества двух стран.
            </p>
        </section>
    );
}
